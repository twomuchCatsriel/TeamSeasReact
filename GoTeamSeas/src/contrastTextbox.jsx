...
function ContrastTextbox({subheaderText, headerText, infoText, buttonvariant1, buttonvariant2, alignment, boxWidth, button1_text, button2_text, button1_destination, button2_destination}){
    return (
        <div>
