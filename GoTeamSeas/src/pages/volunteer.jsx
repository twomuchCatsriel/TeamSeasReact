    ...
    return(
        <div>
            ...
            <section className="infoSection volunteerInfoSection">
                ...
                <BasicTextComponent text="For å bli en frivillig, så må du sende inn et innmeldingsskjema. Vi vil ta kontakt med deg så fort vi kan."/> {/* I can not decide if I should make only a register account page, or if I should make a form like RødeKors does. */}
                ...
                <BasicTextComponent text="Våre frivillige jobbed med å rydde opp strender rundt om hele Norge."></BasicTextComponent>
            </section>
