    ...
    return (
        <div>
            ...
            <section className="infoSection"> 
                <ImageAndText variant="imageLeft" imagePath="./theguys.png" altText="Jimmy Donaldson 'MrBeast' og Mark Rober på en strand" headerText="En Innsats for Verden"
                ...
                <ImageAndText variant="imageRight" imagePath="./boahowoah.jpg" altText="Et fiskenett fylt med plastflasker" headerText="Hvorfor #TeamSeas?"
                ...
                <ImageAndText variant="imageLeft" imagePath="./masked.jpg" altText="Søppel på en strand" headerText="Vårt Oppdrag"
